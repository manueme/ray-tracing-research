...
public:
    ...
    void fromNothing(VkFormat t_format, uint32_t t_texWidth, uint32_t t_texHeight, Device* t_device, VkQueue t_copyQueue, VkFilter t_filter = VK_FILTER_LINEAR,
        VkImageUsageFlags t_imageUsageFlags = VK_IMAGE_USAGE_SAMPLED_BIT,
        VkImageLayout t_imageLayout = VK_IMAGE_LAYOUT_GENERAL,
        bool t_unnormalizedCoordinates = VK_FALSE);
};
