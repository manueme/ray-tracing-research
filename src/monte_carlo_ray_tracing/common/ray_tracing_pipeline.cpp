...
RayTracingPipeline::RayTracingPipeline(Device* t_vulkanDevice,
    ...
    , m_rayTracingPipelineProperties(t_rayTracingPipelineProperties)
{
    m_pathTracerParams = {
...
RayTracingPipeline::~RayTracingPipeline()
{
    ...
    vkDestroyDescriptorSetLayout(m_device,
        m_descriptorSetLayouts.set0AccelerationStructure, nullptr);
...
void RayTracingPipeline::createDescriptorSets(VkDescriptorPool t_descriptorPool,
    ...
    Buffer* t_instancesBuffer, Buffer* t_lightsBuffer, Buffer* t_materialsBuffer)
{
    ...
    descriptorAccelerationStructureInfo.pAccelerationStructures = &t_accelerationStructure;
    ...
    VkDescriptorSetAllocateInfo set3AllocInfo
        = initializers::descriptorSetAllocateInfo(t_descriptorPool,
            &m_descriptorSetLayouts.set3Materials,
            1);
    CHECK_RESULT(vkAllocateDescriptorSets(m_device, &set3AllocInfo, &m_descriptorSets.set3Materials));
