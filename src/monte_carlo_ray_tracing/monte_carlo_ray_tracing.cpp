...
void MonteCarloRTApp::getEnabledFeatures()
{ BaseRTProject::getEnabledFeatures();
}
...
/*
   ...
   (vertices, triangles)
*/
void MonteCarloRTApp::createBottomLevelAccelerationStructure(
...
*/
void MonteCarloRTApp::createTopLevelAccelerationStructure(TlasCreateInfo t_tlasCreateInfo)
{
...
void MonteCarloRTApp::createScene()
{
    // Models
    ...
    geometry.geometry.triangles.vertexStride = m_vertexLayout.stride();
...
void MonteCarloRTApp::createDescriptorSetsLayout()
{
    ...
    VkPipelineLayoutCreateInfo rasterPipelineLayoutCreateInfo
        = initializers::pipelineLayoutCreateInfo(rasterSetLayouts.data(),
            rasterSetLayouts.size());
...
void MonteCarloRTApp::createRTPipeline()
{
    ...
    shaderStages[SBT_BRDF_RAY_GEN_INDEX]
        = loadShader("./shaders/raygen.rgen.spv", VK_SHADER_STAGE_RAYGEN_BIT_KHR);
    shaderStages[SBT_BRDF_MISS_INDEX]
    ...
    shaderStages[SBT_BRDF_ANY_HIT_INDEX]
        = loadShader("./shaders/anyhit.rahit.spv", VK_SHADER_STAGE_ANY_HIT_BIT_KHR);
    shaderStages[SBT_BRDF_CLOSEST_HIT_INDEX]
    ...
    */
    ...
    groups[SBT_BRDF_RAY_GEN_GROUP].type = VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR;
    groups[SBT_BRDF_RAY_GEN_GROUP].generalShader = SBT_BRDF_RAY_GEN_INDEX;
    // Scene miss shader group
    groups[SBT_BRDF_MISS_GROUP].type = VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR;
    groups[SBT_BRDF_MISS_GROUP].generalShader = SBT_BRDF_MISS_INDEX;
    ...
    groups[SBT_BRDF_HIT_GROUP].type = VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR;
    groups[SBT_BRDF_HIT_GROUP].anyHitShader = SBT_BRDF_ANY_HIT_INDEX;
    groups[SBT_BRDF_HIT_GROUP].closestHitShader = SBT_BRDF_CLOSEST_HIT_INDEX;
...
*/
void MonteCarloRTApp::createStorageImage()
{
...
VkDeviceSize MonteCarloRTApp::copyShaderIdentifier(
...
void MonteCarloRTApp::createShaderBindingTable()
{
    ...
    const uint32_t sbtSize
        = m_rayTracingPipelineProperties.shaderGroupHandleSize * NUM_SHADER_GROUPS;
    ...
    data += copyShaderIdentifier(data, shaderHandleStorage, SBT_BRDF_RAY_GEN_GROUP);
    data += copyShaderIdentifier(data, shaderHandleStorage, SBT_BRDF_MISS_GROUP);
    data += copyShaderIdentifier(data, shaderHandleStorage, SBT_SHADOW_MISS_GROUP);
    data += copyShaderIdentifier(data, shaderHandleStorage, SBT_BRDF_HIT_GROUP);
    data += copyShaderIdentifier(data, shaderHandleStorage, SBT_SHADOW_HIT_GROUP);
